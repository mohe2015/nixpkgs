...
lib.makeScope newScope (self: with self; {
  ...
  # THIS IS A GENERATED FILE.  DO NOT EDIT!
  xeyes = callPackage
    ({ stdenv, pkg-config, fetchurl, libX11, libxcb, libXext, libXi, libXmu, xorgproto, libXrender, libXt }: stdenv.mkDerivation {
      pname = "xeyes";
      version = "1.2.0";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xorgproto = callPackage
    ({ stdenv, pkg-config, fetchurl, libXt, python3 }: stdenv.mkDerivation {
      pname = "xorgproto";
      version = "2021.5";
      builder = ./builder.sh;
      src = fetchurl {
